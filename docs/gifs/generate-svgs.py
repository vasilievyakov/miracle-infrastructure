...
checkup = make_svg(
    [
        ...
        ("", "#1e1e2e"),
        ("Scanning ~/.claude/skills/... 17 skills found", "#6c7086", 400),
        ("", "#1e1e2e"),
        ...
        ("  16/17 skills healthy", "#a6e3a1", 2600),
        ("", "#1e1e2e"),
...
install = make_svg(
    [
        ...
        ("17 skills for Claude Code that solve actual problems.", "#6c7086", 300),
        ("", "#1e1e2e"),
        ...
        ("", "#1e1e2e"),
        ("Installing... 17 skills, 3 rules, templates, tests", "#6c7086", 1800),
